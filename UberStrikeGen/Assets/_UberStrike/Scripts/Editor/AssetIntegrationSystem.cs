...
namespace UnityAI
{
    ...
    public static class AssetIntegrationSystem
    {
        public sealed class PrefabCatalogSnapshot
        {
            ...
            public readonly List<GameObject> Pickups = new();
            public readonly List<GameObject> UtilityPrefabs = new();
            public readonly Dictionary<string, List<Material>> ThemeMaterials = new(StringComparer.OrdinalIgnoreCase);
        ...
        private static void ApplySpawnLogic(GameObject root, PrefabCatalogSnapshot snapshot, FlowAnalysisResult flow)
        {
            ...
            {
                return; // assume BuildFromBlueprint already placed them
            }
