...
using System.Linq;
using System.Text;
// using Unity.AI.Navigation; // Requires com.unity.ai.navigation package — disabled for UberStrike 4.3
using UnityEngine;
...
namespace UnityAI
{
    public static class BuildFromStackEnhanced
    {
        ...
        {
            // NavMeshSurface requires com.unity.ai.navigation package.
            // Skipped for UberStrike 4.3 — enable by installing the package and uncommenting.
            Debug.Log("[STACK] NavMesh baking skipped (Unity.AI.Navigation package not installed).");
        }
        ...
        private static bool IsFloorPixel(Color32 c) => ((Color)c).grayscale > 0.2f;
